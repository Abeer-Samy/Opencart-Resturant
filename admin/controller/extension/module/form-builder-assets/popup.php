<link rel="stylesheet" href="./controller/extension/module/form-builder-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="form-builder-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Form Builder</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/form-builder-assets/popup.js';
